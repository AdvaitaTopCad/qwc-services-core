...
class TestApi:
    def test_create_model(self, mocker):
        ...
        create_model.assert_called_with(api, "test_model", fields)
...
def test_create_model():
    ...
    api.model.assert_called_with("some_name", {"field1": str, "field2": int})
...
class TestCaseInsensitiveMultiDict:
    def test_init(self):
        ...
        d = CaseInsensitiveMultiDict({"key1": "value", "KEY2": "value"})
    ...
    def test_contains(self):
        ...
        d = CaseInsensitiveMultiDict({"key": "value"})
    ...
    def test_getlist(self):
        ...
        d = CaseInsensitiveMultiDict({"key1": "value", "KEY2": ["value2", "other2"]})
...
class TestCaseInsensitiveArgument:
    def test_source(self):
        ...
        request.values = {"key1": "value", "KEY2": ["value2", "other2"]}
